...
<head>
  ...
  <title>Libraries and languages available &mdash; Embark 2.4.0 documentation</title>
    ...
    <link rel="top" title="Embark 2.4.0 documentation" href="index.html"/>
        <link rel="next" title="Configuring &amp; Using Contracts" href="using-contracts.html"/>
        <link rel="prev" title="Creating a new DApp" href="creating-a-new-dapp.html"/> 
...
<li class="toctree-l1 current"><a class="current reference internal" href="#">Libraries and languages available</a></li>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  <ul class="wy-breadcrumbs">
    ...
    <li>Libraries and languages available</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="_sources/libraries-and-languages-available.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="libraries-and-languages-available">
<h1>Libraries and languages available<a class="headerlink" href="#libraries-and-languages-available" title="Permalink to this headline">¶</a></h1>
<p>Embark can build and deploy contracts coded in Solidity or Serpent. It
will make them available on the client side using EmbarkJS and Web3.js.</p>
<p>Further documentation for these can be found below:</p>
<ul class="simple">
<li>Smart Contracts:
<a class="reference external" href="https://solidity.readthedocs.io/en/develop/">Solidity</a> and
<a class="reference external" href="https://github.com/ethereum/wiki/wiki/Serpent">Serpent</a></li>
<li>Client Side:
<a class="reference external" href="https://github.com/ethereum/wiki/wiki/JavaScript-API">Web3.js</a>
and <a class="reference external" href="#embarkjs">EmbarkJS</a></li>
</ul>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="using-contracts.html" class="btn btn-neutral float-right" title="Configuring &amp; Using Contracts" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="creating-a-new-dapp.html" class="btn btn-neutral" title="Creating a new DApp" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
