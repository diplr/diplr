...
<head>
  ...
  <title>Deploying to SWARM &mdash; Embark 2.4.0 documentation</title>
    ...
    <link rel="top" title="Embark 2.4.0 documentation" href="index.html"/>
        <link rel="next" title="Extending functionality with plugins" href="plugins.html"/>
        <link rel="prev" title="Deploying to IPFS" href="deploying-to-ipfs.html"/> 
...
<li class="toctree-l1 current"><a class="current reference internal" href="#">Deploying to SWARM</a></li>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  <ul class="wy-breadcrumbs">
    ...
    <li>Deploying to SWARM</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="_sources/deploying-to-swarm.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="deploying-to-swarm">
<h1>Deploying to SWARM<a class="headerlink" href="#deploying-to-swarm" title="Permalink to this headline">¶</a></h1>
<p>To deploy a dapp to SWARM, all you need to do is run a local SWARM node and then run <code class="docutils literal"><span class="pre">embark</span> <span class="pre">upload</span> <span class="pre">swarm</span></code>.</p>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="plugins.html" class="btn btn-neutral float-right" title="Extending functionality with plugins" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="deploying-to-ipfs.html" class="btn btn-neutral" title="Deploying to IPFS" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
