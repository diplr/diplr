...
<head>
  ...
  <title>Dashboard &mdash; Embark 2.4.0 documentation</title>
    ...
    <link rel="top" title="Embark 2.4.0 documentation" href="index.html"/>
        <link rel="next" title="Creating a new DApp" href="creating-a-new-dapp.html"/>
...
<li class="toctree-l1 current"><a class="current reference internal" href="#">Dashboard</a></li>
...
<p>Embark 2 comes with a terminal dashboard.</p>
<div class="figure" id="id1">
<img alt="Dashboard" src="http://i.imgur.com/s4OQZpu.jpg" />
<p class="caption"><span class="caption-text">Dashboard</span></p>
</div>
<p>The dashboard will tell you the state of your contracts, the enviroment
you are using, and what embark is doing at the moment.</p>
<p><strong>available services</strong></p>
<p>Available Services will display the services available to your dapp in
green, if one of these is down then it will be displayed in red.</p>
<p><strong>logs and console</strong></p>
<p>There is a console at the bottom which can be used to interact with
contracts or with embark itself. type <code class="docutils literal"><span class="pre">help</span></code> to see a list of
...
Embark.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="creating-a-new-dapp.html" class="btn btn-neutral float-right" title="Creating a new DApp" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
