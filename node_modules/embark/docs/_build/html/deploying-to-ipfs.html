...
<head>
  ...
  <title>Deploying to IPFS &mdash; Embark 2.4.0 documentation</title>
    ...
    <link rel="top" title="Embark 2.4.0 documentation" href="index.html"/>
        <link rel="next" title="Deploying to SWARM" href="deploying-to-swarm.html"/>
        <link rel="prev" title="Structuring Application" href="structuring-application.html"/> 
...
<li class="toctree-l1 current"><a class="current reference internal" href="#">Deploying to IPFS</a></li>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  <ul class="wy-breadcrumbs">
    ...
    <li>Deploying to IPFS</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="_sources/deploying-to-ipfs.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="deploying-to-ipfs">
<h1>Deploying to IPFS<a class="headerlink" href="#deploying-to-ipfs" title="Permalink to this headline">¶</a></h1>
<p>To deploy a dapp to IPFS, all you need to do is run a local IPFS node
and then run <code class="docutils literal"><span class="pre">embark</span> <span class="pre">upload</span> <span class="pre">ipfs</span></code>. If you want to deploy to the livenet then
after configuring you account on <code class="docutils literal"><span class="pre">config/blockchain.json</span></code> on the
<code class="docutils literal"><span class="pre">livenet</span></code> environment then you can deploy to that chain by
specifying the environment <code class="docutils literal"><span class="pre">embark</span> <span class="pre">ipfs</span> <span class="pre">livenet</span></code>.</p>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="deploying-to-swarm.html" class="btn btn-neutral float-right" title="Deploying to SWARM" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="structuring-application.html" class="btn btn-neutral" title="Structuring Application" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
