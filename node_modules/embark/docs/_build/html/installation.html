...
<head>
  ...
  <title>Installation &mdash; Embark 2.4.0 documentation</title>
    ...
    <link rel="top" title="Embark 2.4.0 documentation" href="index.html"/>
        ...
        <link rel="prev" title="Welcome to embark’s documentation!" href="index.html"/> 
...
<p>Requirements: geth (1.5.8 or higher), node (6.9.1 or higher is recommended) and npm
...
the dapp stack you choose: <a class="reference external" href="https://ipfs.io/">IPFS</a></p>
<div class="code bash highlight-default"><div class="highlight"><pre><span></span>$ npm -g install embark

# If you plan to use the simulator instead of a real ethereum node.
$ npm -g install ethereumjs-testrpc
</pre></div>
</div>
<p>See <a class="reference external" href="https://github.com/iurimatias/embark-framework/wiki/Installation">Complete Installation
Instructions</a>.</p>
<p><strong>updating from embark 1</strong></p>
<p>Embark&#8217;s npm package has changed from <code class="docutils literal"><span class="pre">embark-framework</span></code> to
<code class="docutils literal"><span class="pre">embark</span></code>, this sometimes can create conflicts. To update first
uninstall embark-framework 1 to avoid any conflicts.
<code class="docutils literal"><span class="pre">npm</span> <span class="pre">uninstall</span> <span class="pre">-g</span> <span class="pre">embark-framework</span></code> then <code class="docutils literal"><span class="pre">npm</span> <span class="pre">install</span> <span class="pre">-g</span> <span class="pre">embark</span></code></p>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="index.html" class="btn btn-neutral" title="Welcome to embark’s documentation!" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
