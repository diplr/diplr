...
<head>
  ...
  <title>Working with different chains &mdash; Embark 2.4.0 documentation</title>
    ...
    <link rel="top" title="Embark 2.4.0 documentation" href="index.html"/>
        <link rel="next" title="Structuring Application" href="structuring-application.html"/>
        <link rel="prev" title="Testing Ethereum Contracts" href="tests.html"/> 
...
<li class="toctree-l1 current"><a class="current reference internal" href="#">Working with different chains</a></li>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  <ul class="wy-breadcrumbs">
    ...
    <li>Working with different chains</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="_sources/working-with-different-chains.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="working-with-different-chains">
<h1>Working with different chains<a class="headerlink" href="#working-with-different-chains" title="Permalink to this headline">¶</a></h1>
<p>You can specify which environment to deploy to:</p>
<p><code class="docutils literal"><span class="pre">$</span> <span class="pre">embark</span> <span class="pre">blockchain</span> <span class="pre">livenet</span></code></p>
<p><code class="docutils literal"><span class="pre">$</span> <span class="pre">embark</span> <span class="pre">run</span> <span class="pre">livenet</span></code></p>
<p>The environment is a specific blockchain configuration that can be
managed at config/blockchain.json</p>
<div class="code json highlight-default"><div class="highlight"><pre><span></span><span class="c1"># config/blockchain.json</span>
  <span class="o">...</span>
   <span class="s2">&quot;livenet&quot;</span><span class="p">:</span> <span class="p">{</span>
    <span class="s2">&quot;networkType&quot;</span><span class="p">:</span> <span class="s2">&quot;livenet&quot;</span><span class="p">,</span>
    <span class="s2">&quot;rpcHost&quot;</span><span class="p">:</span> <span class="s2">&quot;localhost&quot;</span><span class="p">,</span>
    <span class="s2">&quot;rpcPort&quot;</span><span class="p">:</span> <span class="mi">8545</span><span class="p">,</span>
    <span class="s2">&quot;rpcCorsDomain&quot;</span><span class="p">:</span> <span class="s2">&quot;http://localhost:8000&quot;</span><span class="p">,</span>
    <span class="s2">&quot;account&quot;</span><span class="p">:</span> <span class="p">{</span>
      <span class="s2">&quot;password&quot;</span><span class="p">:</span> <span class="s2">&quot;config/livenet/password&quot;</span>
    <span class="p">}</span>
  <span class="p">},</span>
  <span class="o">...</span>
</pre></div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="structuring-application.html" class="btn btn-neutral float-right" title="Structuring Application" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="tests.html" class="btn btn-neutral" title="Testing Ethereum Contracts" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
